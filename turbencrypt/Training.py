...
from neuralop.training.trainer import Trainer #load_training_state, save_training_state
...
class Trainer2:
    ...
    def __init__(
        ...
        *,
        ...
        verbose: bool=False,
        clip_grad_norm: float = None,  # Add this line
    ):
        """
        Parameters
        ----------
        ...
        clip_grad_norm : float, optional, default None
            if provided, applies gradient clipping to ensure gradients do not exceed this value.
        """
    ...
    def train_one_batch(self, idx, sample, training_loss):
        ...
        if self.clip_grad_norm is not None:
            utils.clip_grad_norm_(self.model.parameters(), self.clip_grad_norm)  # Add norm clipping here
